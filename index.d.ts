...
*/
declare function bifurcateValuesBy<T = unknown, U = unknown>( x: Collection<T> | AccessorArrayLike<T>, predicate: Predicate<T, U>, thisArg?: ThisParameterType<Predicate<T, U>> ): ValuesResults<T>;


// EXPORTS //

export = bifurcateValuesBy;
